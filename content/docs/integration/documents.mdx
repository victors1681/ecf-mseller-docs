...
> **⚠️ IMPORTANTE - Feature en fase de pruebas**: Esta opción está **activada por defecto** hasta completar la fase de depuración y pruebas. Durante este período, todos los documentos serán validados automáticamente antes de su envío. Una vez estabilizado el feature, esta validación será opcional y controlada explícitamente mediante el parámetro `validate=true`.
