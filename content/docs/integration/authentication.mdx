...
> **Importante**: El token tiene una validez de una hora (3600 segundos). Después de este tiempo, deberás solicitar un nuevo token.

### 2. Usar el token en las solicitudes

Una vez obtenido el token, debes incluirlo en todas las solicitudes subsecuentes junto con tu API Key:
