...
Nota de débito que referencia un documento previo. Requiere la sección `InformacionReferencia` con el eNCF del Tipo 32 (&lt; 250K).
...
> **Nota**: `NCFModificado` se completa automáticamente con el eNCF del Tipo 32 (&lt; 250K) enviado previamente. El `CodigoModificacion` `3` indica "Descuento o bonificación".

---

## Tipo 34 — Nota de Crédito

Nota de crédito con referencia al documento original. También requiere `InformacionReferencia` con el eNCF del Tipo 32 (&lt; 250K).
