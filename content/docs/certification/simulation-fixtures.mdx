---
title: Formato JSON por Tipo de e-CF
description: Ejemplos de JSON para cada tipo de Comprobante Fiscal Electrónico (e-CF) utilizado en las pruebas de simulación CerteCF con MSeller ECF. Tipos 31, 32, 33, 34, 41, 43, 44, 45, 46 y 47.
---

# Formato JSON por Tipo de e-CF

Estos son los formatos JSON que MSeller ECF utiliza durante las [pruebas de simulación](/docs/certification/process#paso-5--pruebas-de-simulación-e-cf) del proceso de certificación. Cada documento sigue la estructura estándar de la DGII.
